      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          {experiences.map((exp, index) => (
            <div
              key={exp.id}
              className={`flex flex-col md:flex-row items-center mb-12 sm:mb-16 ${
            ...
            >
                    ...
                    >
                      ...
                      <span
                        className={`px-3 py-1 bg-gradient-to-r ${getTypeColor(
                          exp.type
                        )} bg-opacity-20 rounded-full text-xs font-medium`}
                      >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-2 py-1 bg-white/20 rounded-full text-xs text-gray-200"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              <div
                className={`w-6 h-6 bg-gradient-to-r ${getTypeColor(
                  exp.type
                )} rounded-full border-4 border-black flex items-center justify-center flex-shrink-0 hidden md:flex`}
              >
